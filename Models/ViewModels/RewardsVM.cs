...
public class RewardsVM
{
    ...
    [Remote("CheckIdAvailability", "Rewards", ErrorMessage = "<i class=\"fa-solid fa-triangle-exclamation\"></i> Duplicated {0}.")]
    ...
    [Remote("CheckNameAvailability", "Rewards", ErrorMessage = "<i class=\"fa-solid fa-triangle-exclamation\"></i> Duplicated {0}.")]
    ...
    [Remote("CheckRewardCodeAvailability", "Rewards", ErrorMessage = "Duplicated {0}.")]
